    ...
    return (
        ...
        <main>
                ...
                <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                  <div className="pr-12">
                    <h1 className="text-white font-semibold text-3xl">
                     YOUR FUTURE PROFESSIONAL ADVANTURE
                    </h1>
                    <p className="mt-4 text-lg text-gray-300">
                      This is the right place if you're looking for a job<br/> 
                      This is also the right place to find people who'd love to join your team 
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            >
              <polygon
                className="text-violet-200 fill-current"
        ...
        <section className="pb-20 bg-violet-200 -mt-24">
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                <div className="text-gray-600 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-violet-600">
            ...
            <div className="items-center flex flex-wrap">
              ...
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                <div className="md:pr-12">
                  <div className="text-yellow-600 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-yellow-600">
                  ...
                  <ul className="list-none mt-6">
                    <li className="py-2">
                      <div className="flex items-center">
                        <div>
                          <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-yellow-600 bg-yellow-600 mr-3">
                            <i className="fas fa-fingerprint"></i>
                          </span>
                        </div>
                        <div>
