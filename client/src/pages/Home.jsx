    ...
    return (
        ...
        <main>
          ...
          >
            ...
            >
              <polygon
                className="text-violet-100 fill-current"
        ...
        <section className="pb-20 bg-violet-100 -mt-24">
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                <div className="text-gray-600 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-yellow-500">
